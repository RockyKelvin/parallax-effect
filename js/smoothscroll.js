 ...
 */
;
(function($) {console.log("smoothscroll");
    var h = $.scrollTo = function(a, b, c) {console.log("aa");
    ...
    h.window = function(a) {console.log("aa");
        return $(window)._scrollable()
    };
    $.fn._scrollable = function() {console.log("aa");
    ...
    $.fn.scrollTo = function(e, f, g) {console.log("aa");
        if (typeof f == 'object') {
            g = f;
            f = 0
        }
